...
| **Phù Loan**<br>`Wings_of_Phoenix` | **Epic (SSR)** | `Support / Tanker` | **Quan Âm Bồ Tát / Tanker Trị Liệu** | HP: `1750`<br>ATK: `150` | +175 HP<br>+15 ATK | **+% HP & +% DEF:**<br>HP: `[12, 14, 16, 18, 20, 25]%`<br>DEF: `[10, 12, 14, 16, 18, 20]%` | **Tăng hiệu quả Kỹ Năng Hồi Máu & Tạo Khiên:**<br>Tăng thêm `[30, 40, 50, 60, 70, 80]%` hiệu quả |
| **Quạt Quế Phách**<br>`Moonlit_Firelfy` | **Legendary (UR)** | `Mage` | **Pháp Sư Hỗ Trợ UR** | HP: `1125`<br>ATK: `275` | +113 HP<br>+28 ATK | **+% Tốc Độ & +% Tấn Công:**<br>SPEED: `[8, 10, 12, 14, 16, 20]%`<br>ATK: `[10, 12, 14, 17, 20, 25]%` | **Tăng hiệu quả Kỹ Năng Cường Hóa, Hỗ Trợ & Tạo Khiên:**<br>Tăng thêm `[40, 50, 60, 70, 80, 100]%` hiệu quả |
...
| **Cửu Hằng Trượng**<br>`Ninefold_Staff` | **Rare (SR)** | `Support` | **Đường Tam Tạng** | HP: `495`<br>ATK: `121` | +50 HP<br>+12 ATK | **+% Tốc Độ (SPEED):**<br>`[5, 6, 7, 8, 10, 12]%` | **Tăng hiệu quả Kỹ Năng Cường Hóa & Hỗ Trợ:**<br>Tăng thêm `[20, 25, 30, 35, 40, 50]%` hiệu quả |
